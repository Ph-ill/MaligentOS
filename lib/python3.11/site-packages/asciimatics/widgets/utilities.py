...
THEMES = {
    ...
    "maligent": defaultdict(
        lambda: (Screen.COLOUR_RED, Screen.A_NORMAL, Screen.COLOUR_BLACK),
        {
            "invalid": (Screen.COLOUR_BLACK, Screen.A_NORMAL, Screen.COLOUR_YELLOW),
            "label": (Screen.COLOUR_RED, Screen.A_BOLD, Screen.COLOUR_BLACK),
            "title": (Screen.COLOUR_RED, Screen.A_BOLD, Screen.COLOUR_BLACK),
            "selected_focus_field": (Screen.COLOUR_RED, Screen.A_BOLD, Screen.COLOUR_BLACK),
            "focus_edit_text": (Screen.COLOUR_RED, Screen.A_BOLD, Screen.COLOUR_BLACK),
            "focus_button": (Screen.COLOUR_RED, Screen.A_BOLD, Screen.COLOUR_BLACK),
            "selected_focus_control": (Screen.COLOUR_RED, Screen.A_BOLD, Screen.COLOUR_BLACK),
            "disabled": (Screen.COLOUR_RED, Screen.A_BOLD, Screen.COLOUR_BLACK),
        }    
    ),
    "maligent2": defaultdict(
        lambda: (Screen.COLOUR_BLACK, Screen.A_NORMAL, Screen.COLOUR_RED),
        {
            "invalid": (Screen.COLOUR_BLACK, Screen.A_NORMAL, Screen.COLOUR_YELLOW),
            "label": (Screen.COLOUR_BLACK, Screen.A_BOLD, Screen.COLOUR_RED),
            "title": (Screen.COLOUR_BLACK, Screen.A_BOLD, Screen.COLOUR_RED),
            "selected_focus_field": (Screen.COLOUR_BLACK, Screen.A_BOLD, Screen.COLOUR_RED),
            "focus_edit_text": (Screen.COLOUR_BLACK, Screen.A_BOLD, Screen.COLOUR_RED),
            "focus_button": (Screen.COLOUR_BLACK, Screen.A_BOLD, Screen.COLOUR_RED),
            "selected_focus_control": (Screen.COLOUR_BLACK, Screen.A_BOLD, Screen.COLOUR_RED),
            "disabled": (Screen.COLOUR_BLACK, Screen.A_BOLD, Screen.COLOUR_RED),
        }    
    ),
    "bright": defaultdict(
